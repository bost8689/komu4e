      ...
      <div class="col-sm-14">
        ...
        <div class="col-sm-14">
          <div class="card">
            ...
            <div class="card-body">          
              <form class="form-horizontal" role="form" method="POST" action="{{route('view_settings')}}">
                {{csrf_field()}} 
                <div class="col-sm-14">
        ...
        <div class="col-sm-14">
          <div class="card">
            ...
            <div class="card-body"> 
              ...
              <div class="col-sm-14">
                <button type="submit" class="btn btn-primary" name="btn_view_wall">Показать</button>
              </div>          
            </form>
            <p>
